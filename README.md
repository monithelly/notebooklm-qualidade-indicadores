...
## 🎯 Objetivo
O objetivo deste projeto é compreender como os fundamentos clássicos da gestão da qualidade podem apoiar a interpretação de indicadores, a identificação de causas de problemas e a proposição de melhorias com apoio da Inteligência Artificial.

## 📚 Fontes utilizadas
- Out of the Crisis – W. Edwards Deming
- Juran Trilogy
- Material sobre Diagrama de Ishikawa
- Conteúdos complementares sobre indicadores de desempenho e gestão da qualidade
